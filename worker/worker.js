...
const PROJECT_KNOWLEDGE = {
  cola: `CoLA — Collaborative Learning Analytics — is a wearable multimodal platform for egocentric sensing, real-time behavioural analysis and interactive facilitation in collaborative learning settings. Rather than watching a group from a camera in the corner of the room, it works from the learners' own point of view. Zaibei designed and built it, and the work was done during his visiting-researcher stay at Hiroshima City University (November 2025 – January 2026). Project site: ucph-cola.org, login-gated, with Live, Sessions, Devices, Config and Admin sections.
Sensing: the learner's own phone is the primary collector. An iOS app records first-person audio, video and motion from the phone the learner is wearing, and it is also what starts and stops the optional ESP32 boards that can add an external audio or video source. Project Aria smart glasses are a second collector and are optional too — a site can run a study without them — and they are where Meta Project Aria enters the picture: a research collaboration was established around this work, and the glasses come through a Meta Project Aria Research Partnership / Hardware Grant (2026). Glasses are registered and assigned, a learner claims a pair and releases it again, and a teacher can connect or disconnect one on the wearer's behalf. The teacher's side runs in the browser.
What it does with that: it transcribes and attributes speech, follows posture and attention, and scores how a group is collaborating — surfacing it live to a teacher with the evidence behind each score, and keeping sessions for review, export and consent withdrawal. How any of that is built is the subject of the system paper and is not described here.
